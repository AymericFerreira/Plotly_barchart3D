...
def test_array_from_barchart():
    ...
    fig = plotly_barcharts_3d(features, neighbours, accuracies,
                        x_title="Features", y_title="Neighbours", z_title="Accuracy").__str__()
    assert(fig.__str__() == """Figure({
    'data': [{'color': '#636EFA',
              'flatshading': True,
              'hoverinfo': 'z',
              'hovertext': 'text',
    ...
    'layout': {'scene': {'xaxis': {'tickmode': 'array',
                                   'ticktext': [2, 3, 5, 10, 20],
                                   'tickvals': array([0, 2, 4, 6, 8]),
                                   'title': {'text': 'Features'}},
                         'yaxis': {'tickmode': 'array',
                                   'ticktext': [31, 24, 10, 28, 48],
                                   'tickvals': array([0, 2, 4, 6, 8]),
    ...
    fig2 = plotly_barcharts_3d(features2, neighbours2, accuracies2,
                              x_title="Features", y_title="Neighbours", z_title="Accuracy").__str__()
...
def test_sparse_from_barchart():
    ...
    fig2 = plotly_barcharts_3d(xdf2, ydf2, zdf2, color='x+y')
