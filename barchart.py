...
def barcharts_from_sparsearray(
...
def plotly_barcharts_3d(
    x_df, y_df, z_df, x_min=0, y_min=0, z_min='auto', step=1, color='x',
    x_legend='auto', y_legend='auto', z_legend='auto', flat_shading=True,
    x_title='', y_title='', z_title='', hover_info='z', title='',
):
    if len(z_df) == (len(x_df) * len(y_df)):
        fig = barcharts3d_fromarray(
            x_df, y_df, z_df, x_min=x_min, y_min=y_min, z_min=z_min, step=step, color=color,
        ...
        fig = barcharts_from_sparsearray(
            x_df, y_df, z_df, x_min=x_min, y_min=y_min, z_min=z_min, step=step,
